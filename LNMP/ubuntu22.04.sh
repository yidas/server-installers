...
# LNMP Installer for Ubuntu 22.04 TLS
#
...
# PHP 7.4
usePhp74=false;
echo "PHP: Do you want to additionally install PHP 7.4? [Y/n, empty as No]"
read yn
case $yn in
    [Yy]* ) usePhp74=true;;
    * ) 
...
if [ $usePhp74 = true ] || [ $usePhp5 = true ]; then
    # PPA
...
if [ $usePhp74 = true ]; then
    # PHP 7.4
    apt-get install php7.4-fpm php7.4-mysql php7.4-cli php7.4-curl php7.4-mbstring php7.4-imagick php7.4-gd php7.4-xml php7.4-zip -y
fi
...
if [ $installPhpMyAdmin = true ]; then
    ...
    # Nginx Default Site
    configUrl='https://raw.githubusercontent.com/yidas/server-installers/master/LNMP/nginx-sites/default-php8.1-all'
